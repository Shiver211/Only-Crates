...
public final class CustomCrateResourcePack implements IResourcePack {
    ...
    private static final String LARGE_CRATE_MODEL = "/assets/onlycrates/models/block/crate_large.json";
    private static final String DEFAULT_SIDE_TEXTURE = "onlycrates:blocks/crate_large";
    private static final String TOP_TEXTURE = "onlycrates:blocks/crate_top";
    ...
    private String generatedModel(String cratePath) throws IOException {
        ...
        String texture = customTextureExists(cratePath) ? textureLocation(cratePath) : DEFAULT_SIDE_TEXTURE;
        return model
                .replace("\"0\": \"onlycrates:blocks/crate_large\"", "\"0\": \"" + texture + "\"")
                .replace("\"1\": \"onlycrates:blocks/crate_top\"", "\"1\": \"" + TOP_TEXTURE + "\"");
    }
